...
inferemce_index = []
# horse_name_without_nan = []

# for i, horse_name in tqdm.tqdm(enumerate(inference_horse_name)):
#     print("{}R処理開始".format(i))

# for i in range(3):
i =2
print("{}R処理開始".format(i))

horse_name = inference_horse_name[i]
...
# 推論したいレースの前走５つのデータ作成
# _,file_name = learning_method.make_past_grades(debag_mode, assume_id, i ,horse_name_without_nan, data, yearStart, yearEnd)
if debag_mode:
    file_name = ["/Users/hayat/Desktop/keiba_analysis/index/2022050402/0_20000_2005_2022_index.csv","/Users/hayat/Desktop/keiba_analysis/index/2022050402/1_20000_2005_2022_index.csv",
            "/Users/hayat/Desktop/keiba_analysis/index/2022050402/2_20000_2005_2022_index.csv"]
else:
    file_name = ["/mnt/c/Users/hayat/Desktop/keiba_analysis/index/2022050402/0_20000_2005_2022_index.csv","/mnt/c/Users/hayat/Desktop/keiba_analysis/index/2022050402/1_20000_2005_2022_index.csv",
            "/mnt/c/Users/hayat/Desktop/keiba_analysis/index/2022050402/2_20000_2005_2022_index.csv"]

# file_name = "/Users/hayat/Desktop/keiba_analysis/index/2022050402/0_20000_2005_2022_index.csv"
var_Index_this_time = np.array(pd.read_csv(file_name[i],encoding="shift_jis",header=None,names = var_name))
...
df.to_csv(inference_path + "/"+"total" +"_result_______.csv", encoding="shift_jis")
